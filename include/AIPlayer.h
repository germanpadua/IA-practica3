...
public:
    ...
    void thinkPodaAlfaBeta(color &c_piece, int &id_piece, int &dice) const;
    ...
    static double heuristica5(const Parchis &estado, int jugador);

    static double heuristica6(const Parchis &estado, int jugador);
    
    //static double heuristica7(const Parchis &estado, int jugador);
    ...
    static bool hayFichaDistintaDetras(const Parchis &estado, int jugador, Box b);

    static bool hayFichaDistintaMuyCerca(const Parchis &estado, int jugador, Box b);
};
#endif